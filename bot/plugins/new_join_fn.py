...
async def help_message_f(client, message):
    ...
    ## Force Sub ##
    await message.reply_text(
        Localisation.HELP_MESSAGE.format(name=message.from_user.mention),
        reply_markup=InlineKeyboardMarkup(
            [
                [
                ...
                [
                    InlineKeyboardButton('ᴅᴇᴠᴇʟᴏᴘᴇʀ', url='https://t.me/TanuJairam'), # Bloody Thief, Don't Become a Developer by Stealing other's Codes & Hard Works!
                    InlineKeyboardButton('ᴏᴛʜᴇʀ ʙᴏᴛs', url='https://t.me/REX_BOTZ/94') # Must Give us Credits!
                ]
            ]
        ),
        quote=True
